...
// tb_rca4: exhaustive over all 4-bit a, 4-bit b and cin (2^9 = 512 cases),
// checked against the integer sum a+b+cin split into {carry_out,sum}.
module tb_rca4;
    ...
    rca4 dut (.a(a), .b(b), .cin(cin), .sum(sum), .carry_out(carry_out));
